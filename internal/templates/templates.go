...
# Jira integration — credentials stay here, never in project configs.
# Run 'sadr config --setup-jira' to configure interactively (recommended).
# The setup command will populate the fields below automatically.
#
# jira:
#   # OAuth 1.0a — populated by: sadr config --setup-jira
#   consumer_key: ""
#   private_key_path: ""
#   access_token: ""
#   access_token_secret: ""
#
#   # Bearer / PAT (Jira Server 8.14+ or Data Center)
#   token: ""
#
#   # Basic Auth (requires Basic Auth enabled on your Jira instance)
#   username: ""
#   password: ""
`
